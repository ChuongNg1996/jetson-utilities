...
while (1):
    ...
    f = open("imu_data","w")
    #f.write("x: " + str(float(xChange)) + "\t y: "+ str(float(yChange)) + "\t z: " + str(float(zChange)) + "Roll: " + str(float(rollChange)) + "\t Pitch: " + str(float(pitchChange)) + "\t Yaw: " + str(float(yawChange)))
    #f.write(str(float(xChange)) + ' ' + str(float(yChange)) + ' ' + str(float(zChange)) + ' ' + str(float(rollChange)) + ' ' + str(float(pitchChange)) + ' ' + str(float(yawChange)))
    f.write(str(float(yawChange)))
    f.close()
